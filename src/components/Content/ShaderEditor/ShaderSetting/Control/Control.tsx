...
function Control({setting, value, onChange}: Props) {
    ...
    } else if (setting.format === Format.VEC3) {
    ...
    } else if (setting.format === Format.VEC4) {
    ...
    } else if (setting.format === Format.INTEGER) {
    ...
    } else if (setting.format === Format.BOOLEAN) {
    ...
    } else if (setting.format === Format.ENUM) {
